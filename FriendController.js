...
for (var i = 0; i < $scope.friends.length; i++) {
  $scope.friends[i].friend_count = parseInt($scope.friends[i].friend_count);
}

$scope.sortOptions = [{option: "name", orderBy: "name"},{option: "Friend #", orderBy: "friend_count"},{option: "city", orderBy: "current_location.city"},{option: "state", orderBy: "current_location.state"}]
